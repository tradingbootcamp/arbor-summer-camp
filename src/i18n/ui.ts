...
export const ui = {
	en: {
		...
		"minimal.subtitle": "A mysterious organization called Arbor stepped forward to run an experimental summer camp from June 2–6, 2025. This event has concluded.",
		"minimal.tickets": "Event Concluded",
