...
export const ui = {
	en: {
		...
		homepage: "Homepage",
		tagline:
			"A container for the greater Lighthaven community to participate in intimate, multi-day events in the most target-rich environment that exists for them, anywhere in the world, any time in the year.",
		...
		"minimal.title": "Arbor Summer College",
		...
		"seo.content": "Summer Camp by ARBOR; also OUGHt helped For AI Reasons — or Scarborough Fair 2025 — is a container for the greater Lighthaven community to run intimate, multi-day events in the most target-rich environment that exists for them, anywhere in the world, any time in the year.",
