...
export const ui = {
	en: {
		...
		"minimal.subtitle": "A mysterious organization called Arbor has stepped forward to run an experimental summer college of sorts from June 2–6. Hot meals are included for all 5 days. [1-2 additional sentence will go here]",
		...
		"seo.content": "Arbor Summer College",
